...
namespace _11242022_Gin_Rummy
{
    public static class GameRound
    {
        ...
        static void AssignWinnerNumber(bool isPlayerOneTurn)
        {
            if (isPlayerOneTurn)
            {
                winnerNumber = 1;
        ...
        static void DiscardFromHand(bool isPlayerOneTurn, int userInput)
        {
            if (isPlayerOneTurn)
            {
        ...
        static void DetectIfGinHasOccurred()
        {
            if (isPlayerOneTurn)
            {
        ...
        static void FirstTurnChanceToPickupFromDiscardPile()
        {
        ...
        static void PromptPlayerToKnock()
        {
            ...
            while (userKnockInput != 'k' && userKnockInput != 'K' && userKnockInput != 'd' && userKnockInput != 'D')
            {
                ...
                switch (userKnockInput)
                {
                    ...
                    case 'K':
                        ...
                        isGameOver = true;
                        AssignWinnerNumber(isPlayerOneTurn);
        ...
        static void NonKnockerCombinesUnmatchedCardsWithKnockersMelds()
        {
        ...
        static void UpdatePlayerScoresAfterKnocking()
        {
            handPlayerOneValue = CalculateHandValue(handPlayerOne);
            handPlayerTwoValue = CalculateHandValue(handPlayerTwo);
            ...
            if (isPlayerOneTurn)
            {
                ...
                if (points < 0) playerOneRoundScore += Math.Abs(points);
            ...
            else
            {
                ...
                if (points > 0) playerTwoRoundScore += Math.Abs(points);
        ...
        static void DetermineIfKnockingEligible()
        {
            if (isGameOver) return;
        ...
        static void SortHandsDetectMelds()
        {
